...
module.exports = {
  get: function (req, res) {
    var url = `https://${req.apiGateway.event.headers.Host}/${req.apiGateway.event.requestContext.stage}`;
    res.json({
      name: "Burndown",
      ...
      capabilities: {
        ...
        hipchatApiConsumer: {
          avatar: {
            url: `https://s3-eu-west-1.amazonaws.com/${process.env.s3bucket}/Fire.png`
          },
          scopes: [
            "send_notification",
            "send_message"
